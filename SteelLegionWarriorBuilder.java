...
public class SteelLegionWarriorBuilder extends CharacterBuilder {
	...
	@Override
	public SteelLegionWarriorBuilder addResistance(AttackType resistance, double value) {
	...
	@Override
	public SteelLegionWarriorBuilder addVulnerability(AttackType vulnerability, double value) {
	...
	@Override
	public SteelLegionWarriorBuilder Type(CharacterType type) {
		this.Type = type;
		return this;
	}
